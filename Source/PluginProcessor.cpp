...
#include "AudioParameterConnections.h" // constains the connection between raw float pointers and their ValueTree counter
    ...
    WavetableContainer::getInstance().createLFOCoefficientsFromConstSections(0, sections, 4, "Pyramid4");

    float p6[6] = {-1.f, -0.333333f, 0.3333333f, 1.f, 0.3333333f, -0.33333333f};
    WavetableContainer::getInstance().createLFOCoefficientsFromConstSections(1, p6, 6, "Pyramid6");

    float p8[8] = {-1.f, -0.5f, 0.f, 0.5f, 1.f, 0.5f, 0.f, -0.5f};
    WavetableContainer::getInstance().createLFOCoefficientsFromConstSections(2, p8, 8, "Pyramid8");

    float p12[12] = {-1.f, -0.666666666f, -0.33333333f, 0.f, 0.3333333f, 0.666666666f, 1.f, 0.6666666f, 0.33333333f, 0.f, -0.333333333f, -0.6666666f};
    WavetableContainer::getInstance().createLFOCoefficientsFromConstSections(3, p12, 12, "Pyramid12");

    float s3[3] = {-1.f, 0.f, 1.f};
    WavetableContainer::getInstance().createLFOCoefficientsFromConstSections(4, s3, 3, "Stair3");

    float s4[4] = {-1.f, -0.333333f, 0.333333f, 1.f};
    WavetableContainer::getInstance().createLFOCoefficientsFromConstSections(5, s4, 4, "Stair4");

    float s6[6] = {-1.f, -0.6f, -0.2f, 0.2f, 0.6f, 1.f};
    WavetableContainer::getInstance().createLFOCoefficientsFromConstSections(6, s6, 6, "Stair6");
    ...
    WavetableContainer::getInstance().createLFOCoefficientsFromConstSections(7, s, 8, "Stair8");
    for (int i = 0; i < 12; ++i)
    {
        s[i] = -1.f + i * (2.f / 11.f);
    }
    WavetableContainer::getInstance().createLFOCoefficientsFromConstSections(8, s, 12, "Stair12");
    float square[8] = {1.f, -1.f, -1.f, -1.f, -1.f, -1.f, -1.f, -1.f};
    WavetableContainer::getInstance().createLFOCoefficientsFromConstSections(9, square, 2, "Square50");
    WavetableContainer::getInstance().createLFOCoefficientsFromConstSections(10, square, 4, "Square25");
    WavetableContainer::getInstance().createLFOCoefficientsFromConstSections(11, square, 8, "Square12");
