...

{
  ...
  std::make_unique<AudioParameterInt> ("osc1_vec_b", "Oscillator1 Vector B", 0, 3, 1),
  std::make_unique<AudioParameterInt> ("osc1_vec_c", "Oscillator1 Vector C", 0, 3, 1),
  std::make_unique<AudioParameterInt> ("osc1_vec_d", "Oscillator1 Vector D", 0, 3, 1),
