...

{
  ...
  std::make_unique<AudioParameterInt>("osc1_type", "Oscillator1 Type", 1, 11,
      ...
      std::make_unique<AudioParameterInt>(
          "delay_position", "Delay Drag n Drop Position", 0, 3, 0),
      std::make_unique<AudioParameterInt>(
          "phaser_position", "Phaser Drag n Drop Position", 0, 3, 1),
      std::make_unique<AudioParameterInt>(
          "flanger_position", "Flanger Drag n Drop Position", 0, 3, 2),
      std::make_unique<AudioParameterInt>(
          "chorus_position", "Chorus Drag n Drop Position", 0, 3, 3),
      // Delay
