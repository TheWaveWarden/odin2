...

{
  ...
  std::make_unique<AudioParameterInt> ("osc1_analog_wave", "Oscillator1 Analog Waveform", 1, 4, 1),  
  ...
  std::make_unique<AudioParameterInt> ("osc1_vec_a", "Oscillator1 Vector A", 1, 1000, 101),
  std::make_unique<AudioParameterInt> ("osc1_vec_b", "Oscillator1 Vector B", 1, 1000, 102),
  std::make_unique<AudioParameterInt> ("osc1_vec_c", "Oscillator1 Vector C", 1, 1000, 103),
  std::make_unique<AudioParameterInt> ("osc1_vec_d", "Oscillator1 Vector D", 1, 1000, 104),
  ...
  std::make_unique<AudioParameterInt> ("osc2_analog_wave", "Oscillator2 Analog Waveform", 1, 4, 1),  
  ...
  std::make_unique<AudioParameterInt> ("osc2_vec_a", "Oscillator2 Vector A", 1, 1000, 101),
  std::make_unique<AudioParameterInt> ("osc2_vec_b", "Oscillator2 Vector B", 1, 1000, 102),
  std::make_unique<AudioParameterInt> ("osc2_vec_c", "Oscillator2 Vector C", 1, 1000, 103),
  std::make_unique<AudioParameterInt> ("osc2_vec_d", "Oscillator2 Vector D", 1, 1000, 104),
  ...
  std::make_unique<AudioParameterInt> ("osc2_chipwave", "Oscillator2 Chiptune wave", 1, 5, 1),
  ...
  std::make_unique<AudioParameterInt> ("osc3_vec_a", "Oscillator3 Vector A", 1, 1000, 101),
  std::make_unique<AudioParameterInt> ("osc3_vec_b", "Oscillator3 Vector B", 1, 1000, 102),
  std::make_unique<AudioParameterInt> ("osc3_vec_c", "Oscillator3 Vector C", 1, 1000, 103),
  std::make_unique<AudioParameterInt> ("osc3_vec_d", "Oscillator3 Vector D", 1, 1000, 104),
  ...
  std::make_unique<AudioParameterInt> ("osc3_chipwave", "Oscillator3 Chiptune wave", 1, 5, 1),
  ...
  std::make_unique<AudioParameterFloat> ("amount_2_[0]", "amount_2_[0]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_3_[0]", "amount_3_[0]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_1_[1]", "amount_1_[1]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_2_[1]", "amount_2_[1]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_3_[1]", "amount_3_[1]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_1_[2]", "amount_1_[2]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_2_[2]", "amount_2_[2]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_3_[2]", "amount_3_[2]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_1_[3]", "amount_1_[3]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_2_[3]", "amount_2_[3]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_3_[3]", "amount_3_[3]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_1_[4]", "amount_1_[4]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_2_[4]", "amount_2_[4]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_3_[4]", "amount_3_[4]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_1_[5]", "amount_1_[5]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_2_[5]", "amount_2_[5]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_3_[5]", "amount_3_[5]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_1_[6]", "amount_1_[6]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_2_[6]", "amount_2_[6]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_3_[6]", "amount_3_[6]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_1_[7]", "amount_1_[7]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_2_[7]", "amount_2_[7]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_3_[7]", "amount_3_[7]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_1_[8]", "amount_1_[8]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_2_[8]", "amount_2_[8]", -1,1,0),
  std::make_unique<AudioParameterFloat> ("amount_3_[8]", "amount_3_[8]", -1,1,0), 

  std::make_unique<AudioParameterInt> ("source_[0]", "source_[0]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("source_[1]", "source_[1]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("source_[2]", "source_[2]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("source_[3]", "source_[3]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("source_[4]", "source_[4]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("source_[5]", "source_[5]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("source_[6]", "source_[6]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("source_[7]", "source_[7]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("source_[8]", "source_[8]", 0,1000,0), 
  
  std::make_unique<AudioParameterInt> ("dest_1_[0]", "dest_1_[0]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_1_[1]", "dest_1_[1]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_1_[2]", "dest_1_[2]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_1_[3]", "dest_1_[3]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_1_[4]", "dest_1_[4]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_1_[5]", "dest_1_[5]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_1_[6]", "dest_1_[6]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_1_[7]", "dest_1_[7]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_1_[8]", "dest_1_[8]", 0,1000,0), 
  
  std::make_unique<AudioParameterInt> ("dest_2_[0]", "dest_2_[0]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_2_[1]", "dest_2_[1]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_2_[2]", "dest_2_[2]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_2_[3]", "dest_2_[3]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_2_[4]", "dest_2_[4]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_2_[5]", "dest_2_[5]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_2_[6]", "dest_2_[6]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_2_[7]", "dest_2_[7]", 0,1000,0), 
  std::make_unique<AudioParameterInt> ("dest_2_[8]", "dest_2_[8]", 0,1000,0), 
