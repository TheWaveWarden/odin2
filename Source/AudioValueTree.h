...

{
	// Osc 1
		...
		std::make_unique<AudioParameterFloat>("step_0_mod", "Arp Step 1 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_1_mod", "Arp Step 2 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_2_mod", "Arp Step 3 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_3_mod", "Arp Step 4 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_4_mod", "Arp Step 5 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_5_mod", "Arp Step 6 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_6_mod", "Arp Step 7 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_7_mod", "Arp Step 8 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_8_mod", "Arp Step 9 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_9_mod", "Arp Step 10 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_10_mod", "Arp Step 11 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_11_mod", "Arp Step 12 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_12_mod", "Arp Step 13 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_13_mod", "Arp Step 14 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_14_mod", "Arp Step 15 Mod", -1, 1, 0),
	    std::make_unique<AudioParameterFloat>("step_15_mod", "Arp Step 16 Mod", -1, 1, 0),
