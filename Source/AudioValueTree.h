...

{
  // Oscillator 1
      ...
      // ModMatrix
      std::make_unique<AudioParameterFloat>("amount_1_[0]", "row1_dest1_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_2_[0]", "row1_dest2_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_3_[0]", "row1_scale_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_1_[1]", "row2_dest1_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_2_[1]", "row2_dest2_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_3_[1]", "row2_scale_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_1_[2]", "row3_dest1_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_2_[2]", "row3_dest2_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_3_[2]", "row3_scale_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_1_[3]", "row4_dest1_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_2_[3]", "row4_dest2_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_3_[3]", "row4_scale_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_1_[4]", "row5_dest1_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_2_[4]", "row5_dest2_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_3_[4]", "row5_scale_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_1_[5]", "row6_dest1_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_2_[5]", "row6_dest2_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_3_[5]", "row6_scale_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_1_[6]", "row7_dest1_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_2_[6]", "row7_dest2_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_3_[6]", "row7_scale_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_1_[7]", "row8_dest1_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_2_[7]", "row8_dest2_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_3_[7]", "row8_scale_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_1_[8]", "row9_dest1_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_2_[8]", "row9_dest2_amount", -1,
                                            1, 0),
      std::make_unique<AudioParameterFloat>("amount_3_[8]", "row9_scale_amount", -1,
                                            1, 0),
