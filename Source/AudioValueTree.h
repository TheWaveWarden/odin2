...

{
  ...
  std::make_unique<AudioParameterInt>("osc1_type", "Oscillator1 Type", 1, 11,
      ...
      std::make_unique<AudioParameterInt>("lfo1_wave", "LFO1 Waveform", 0, 20,
                                          0),
      std::make_unique<AudioParameterInt>("lfo1_synctime_numerator",
                                          "LFO1 SyncTime Numerator", 1, 8, 3),
      std::make_unique<AudioParameterInt>("lfo1_synctime_denominator",
                                          "LFO1 SyncTime Denominator", 1, 9, 6),
      ...
      std::make_unique<AudioParameterInt>("lfo2_wave", "LFO2 Waveform", 0, 20,
                                          0),
      std::make_unique<AudioParameterInt>("lfo2_synctime_numerator",
                                          "LFO2 SyncTime Numerator", 1, 8, 3),
      std::make_unique<AudioParameterInt>("lfo2_synctime_denominator",
                                          "LFO2 SyncTime Denominator", 1, 9, 6),
      ...
      std::make_unique<AudioParameterInt>("lfo3_wave", "LFO3 Waveform", 0, 20,
                                          0),
      std::make_unique<AudioParameterInt>("lfo3_synctime_numerator",
                                          "LFO3 SyncTime Numerator", 1, 8, 3),
      std::make_unique<AudioParameterInt>("lfo3_synctime_denominator",
                                          "LFO3 SyncTime Denominator", 1, 9, 6),
      ...
      std::make_unique<AudioParameterInt>("lfo4_wave", "LFO4 Waveform", 0, 20,
                                          0),
      std::make_unique<AudioParameterInt>("lfo4_synctime_numerator",
                                          "LFO4 SyncTime Numerator", 1, 8, 3),
      std::make_unique<AudioParameterInt>("lfo4_synctime_denominator",
                                          "LFO4 SyncTime Denominator", 1, 9, 6),
      ...
      std::make_unique<AudioParameterFloat>("delay_wet", "Delay Wet", 0.f, 1.f,
                                            0.8f),
      std::make_unique<AudioParameterInt>("delay_synctime_numerator",
                                          "Delay SyncTime Numerator", 1, 8, 3),
      std::make_unique<AudioParameterInt>(
      ...
      std::make_unique<AudioParameterFloat>("phaser_freq", "Phaser Frequency", 80, 18000, 2000),
      std::make_unique<AudioParameterFloat>("phaser_width", "Phaser Width", 0,1,0.5f),
      std::make_unique<AudioParameterInt>("phaser_selected", "Phaser Selected", 0, 1, 0),
      std::make_unique<AudioParameterFloat>(
          "phaser_rate", "Phaser Frequency", 0.05f, 20.f, 1.f),
      ...
      std::make_unique<AudioParameterInt>("phaser_synctime_numerator",
                                          "Phaser SyncTime Numerator", 1, 8, 3),
      std::make_unique<AudioParameterInt>("phaser_synctime_denominator",
                                          "Phaser SyncTime Denominator", 1, 9,
                                          6),
      // Flanger
      ...
      std::make_unique<AudioParameterFloat>("flanger_drywet", "Flanger DryWet",
                                            0.f, 1.f, 1.f),
      std::make_unique<AudioParameterInt>(
          "flanger_synctime_numerator", "Flanger SyncTime Numerator", 1, 8, 3),
      std::make_unique<AudioParameterInt>("flanger_synctime_denominator",
                                          "Flanger SyncTime Denominator", 1, 9,
                                          6),
      // Chorus
      ...
      std::make_unique<AudioParameterInt>("source_[0]", "source_[0]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("source_[1]", "source_[1]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("source_[2]", "source_[2]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("source_[3]", "source_[3]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("source_[4]", "source_[4]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("source_[5]", "source_[5]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("source_[6]", "source_[6]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("source_[7]", "source_[7]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("source_[8]", "source_[8]", 0, 1000,
                                          0),

      std::make_unique<AudioParameterInt>("dest_1_[0]", "dest_1_[0]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_1_[1]", "dest_1_[1]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_1_[2]", "dest_1_[2]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_1_[3]", "dest_1_[3]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_1_[4]", "dest_1_[4]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_1_[5]", "dest_1_[5]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_1_[6]", "dest_1_[6]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_1_[7]", "dest_1_[7]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_1_[8]", "dest_1_[8]", 0, 1000,
                                          0),

      std::make_unique<AudioParameterInt>("dest_2_[0]", "dest_2_[0]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_2_[1]", "dest_2_[1]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_2_[2]", "dest_2_[2]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_2_[3]", "dest_2_[3]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_2_[4]", "dest_2_[4]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_2_[5]", "dest_2_[5]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_2_[6]", "dest_2_[6]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_2_[7]", "dest_2_[7]", 0, 1000,
                                          0),
      std::make_unique<AudioParameterInt>("dest_2_[8]", "dest_2_[8]", 0, 1000,
                                          0),

      std::make_unique<AudioParameterInt>("scale_[0]", "scale_[0]", 0, 1000, 0),
      std::make_unique<AudioParameterInt>("scale_[1]", "scale_[1]", 0, 1000, 0),
      std::make_unique<AudioParameterInt>("scale_[2]", "scale_[2]", 0, 1000, 0),
      std::make_unique<AudioParameterInt>("scale_[3]", "scale_[3]", 0, 1000, 0),
      std::make_unique<AudioParameterInt>("scale_[4]", "scale_[4]", 0, 1000, 0),
