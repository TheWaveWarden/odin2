...

{
  ...
  std::make_unique<AudioParameterInt> ("osc1_vec_a", "Oscillator1 Vector A", 101, 1000, 101),
  std::make_unique<AudioParameterInt> ("osc1_vec_b", "Oscillator1 Vector B", 101, 1000, 102),
  std::make_unique<AudioParameterInt> ("osc1_vec_c", "Oscillator1 Vector C", 101, 1000, 103),
  std::make_unique<AudioParameterInt> ("osc1_vec_d", "Oscillator1 Vector D", 101, 1000, 104),
