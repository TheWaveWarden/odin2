...

{
  // Oscillator 1
      ...
      std::make_unique<AudioParameterFloat>("env1_attack", "AmpEnv Attack",
                                            0.001f, 10.f, 0.01f),
      std::make_unique<AudioParameterFloat>("env1_decay", "AmpEnv Decay",
                                            0.001f, 10.f, 1.f),
      std::make_unique<AudioParameterFloat>("env1_sustain", "AmpEnv Sustain",
                                            0.f, 1.f, 0.5f),
      std::make_unique<AudioParameterFloat>("env1_release", "AmpEnv Release",
                                            0.001f, 10.f, 0.01f),
      std::make_unique<AudioParameterInt>("env1_loop", "AmpEnv Loop", 0, 1,
                                          0),
      // ADSR2
      std::make_unique<AudioParameterFloat>("env2_attack", "FilterEnv Attack",
                                            0.001f, 10.f, 0.01f),
      std::make_unique<AudioParameterFloat>("env2_decay", "FilterEnv Decay",
                                            0.001f, 10.f, 1.f),
      std::make_unique<AudioParameterFloat>("env2_sustain", "FilterEnv Sustain",
                                            0.f, 1.f, 0.5f),
      std::make_unique<AudioParameterFloat>("env2_release", "FilterEnv Release",
                                            0.001f, 10.f, 0.01f),
      std::make_unique<AudioParameterInt>("env2_loop", "FilterEnv Loop", 0, 1,
                                          0),
      // ADSR3
      std::make_unique<AudioParameterFloat>("env3_attack", "ModEnv Attack",
                                            0.001f, 10.f, 0.01f),
      std::make_unique<AudioParameterFloat>("env3_decay", "ModEnv Decay",
                                            0.001f, 10.f, 1.f),
      std::make_unique<AudioParameterFloat>("env3_sustain", "ModEnv Sustain",
                                            0.f, 1.f, 0.5f),
      std::make_unique<AudioParameterFloat>("env3_release", "ModEnv Release",
                                            0.001f, 10.f, 0.01f),
      std::make_unique<AudioParameterInt>("env3_loop", "ModEnv Loop", 0, 1,
                                          0),
      // ADSR4
      std::make_unique<AudioParameterFloat>("env4_attack", "GlobalEnv Attack",
                                            0.001f, 10.f, 0.01f),
      std::make_unique<AudioParameterFloat>("env4_decay", "GlobalEnv Decay",
                                            0.001f, 10.f, 1.f),
      std::make_unique<AudioParameterFloat>("env4_sustain", "GlobalEnv Sustain",
                                            0.f, 1.f, 0.5f),
      std::make_unique<AudioParameterFloat>("env4_release", "GlobalEnv Release",
                                            0.001f, 10.f, 0.01f),
