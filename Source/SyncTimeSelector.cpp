...
SyncTimeSelector::SyncTimeSelector() 
  ...
  m_up_left.setImages(&up_draw2, &up_draw2, &up_draw1, &up_draw1, &up_draw2,
  ...
  m_up_left.setColour(juce::DrawableButton::ColourIds::backgroundOnColourId,
                      juce::Colour());
  m_up_left.onClick = [&]() { incrementLeft(); };
  m_up_left.setAlwaysOnTop(true);

  m_up_right.setImages(&up_draw2, &up_draw2, &up_draw1, &up_draw1, &up_draw2,
                       &up_draw2, &up_draw1, &up_draw1);
  m_up_right.setClickingTogglesState(true);
  m_up_right.setBounds(up_1.getWidth() + glas_panel.getWidth() -2, 1,
                       up_1.getWidth(), up_1.getHeight());
  addAndMakeVisible(m_up_right);
  m_up_right.setTriggeredOnMouseDown(false);
  m_up_right.setColour(juce::DrawableButton::ColourIds::backgroundOnColourId,
                       juce::Colour());
  ...
  m_down_left.setImages(&down_draw2, &down_draw2, &down_draw1, &down_draw1,
                        &down_draw2, &down_draw2, &down_draw1, &down_draw1);
  m_down_left.setClickingTogglesState(true);
  m_down_left.setBounds(3, 1 + down_1.getHeight(), down_1.getWidth(),
                        down_1.getHeight());
  addAndMakeVisible(m_down_left);
  m_down_left.setTriggeredOnMouseDown(false);
  m_down_left.setColour(juce::DrawableButton::ColourIds::backgroundOnColourId,
                        juce::Colour());
  ...
  m_down_right.setImages(&down_draw2, &down_draw2, &down_draw1, &down_draw1,
                         &down_draw2, &down_draw2, &down_draw1, &down_draw1);
  m_down_right.setClickingTogglesState(true);
  m_down_right.setBounds(up_1.getWidth() + glas_panel.getWidth() -2,
                         1 + down_1.getHeight(), down_1.getWidth(),
                         down_1.getHeight());
  addAndMakeVisible(m_down_right);
  m_down_right.setTriggeredOnMouseDown(false);
  m_down_right.setColour(juce::DrawableButton::ColourIds::backgroundOnColourId,
                         juce::Colour());
  m_down_right.onClick = [&]() { decrementRight(); };
  m_down_right.setAlwaysOnTop(true);

  updateDisplay();
  setSize(glas_panel.getWidth() + 2 * down_1.getWidth(),
          glas_panel.getHeight());
