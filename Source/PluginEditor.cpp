...
OdinEditor::OdinEditor(OdinAudioProcessor &p_processor, AudioProcessorValueTreeState &vts, bool p_is_standalone) :
    ...
    m_flanger_on_button("flanger_button", "Flanger On"),
    m_phaser_on_button("phaser_button", "Phaser On"),
    m_chorus_on_button("chorus_button", "Chorus On"),
    m_delay_on_button("delay_button", "Delay On"),
    m_reverb_on_button("reverb_button", "Reverb On"),
    m_select_arp_button("select_arpeggiator_button", "Arpeggiator"),
    ...
    m_chorus(vts, "chorus", p_is_standalone),
    m_xy_section(vts, "xy"),
