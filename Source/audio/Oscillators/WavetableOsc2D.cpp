...
void WavetableOsc2D::loadWavetables(){
  ...
  setWavetablePointer(19, 3, WavetableContainer::getInstance().getWavetablePointers("AKWF_hvoice_0093"));
    ...
    setWavetablePointer(20, 2, WavetableContainer::getInstance().getWavetablePointers("Additive3"));
    setWavetablePointer(20, 3, WavetableContainer::getInstance().getWavetablePointers("Additive4"));

    setWavetablePointer(21, 0, WavetableContainer::getInstance().getWavetablePointers("Additive5"));
    setWavetablePointer(21, 1, WavetableContainer::getInstance().getWavetablePointers("Additive6"));
    setWavetablePointer(21, 2, WavetableContainer::getInstance().getWavetablePointers("Additive7"));
    setWavetablePointer(21, 3, WavetableContainer::getInstance().getWavetablePointers("Additive8"));

    setWavetablePointer(22, 0, WavetableContainer::getInstance().getWavetablePointers("Additive9"));
    setWavetablePointer(22, 1, WavetableContainer::getInstance().getWavetablePointers("Additive10"));
    setWavetablePointer(22, 2, WavetableContainer::getInstance().getWavetablePointers("Additive11"));
    setWavetablePointer(22, 3, WavetableContainer::getInstance().getWavetablePointers("Additive12"));

    setWavetablePointer(23, 0, WavetableContainer::getInstance().getWavetablePointers("Additive13"));
    setWavetablePointer(23, 1, WavetableContainer::getInstance().getWavetablePointers("Additive14"));
    setWavetablePointer(23, 2, WavetableContainer::getInstance().getWavetablePointers("Additive15"));
    setWavetablePointer(23, 3, WavetableContainer::getInstance().getWavetablePointers("Additive16"));

    setWavetablePointer(24, 0, WavetableContainer::getInstance().getWavetablePointers("Harmonics9"));//overtones 1-4
    setWavetablePointer(24, 1, WavetableContainer::getInstance().getWavetablePointers("Harmonics10"));
    setWavetablePointer(24, 2, WavetableContainer::getInstance().getWavetablePointers("Harmonics11"));
    setWavetablePointer(24, 3, WavetableContainer::getInstance().getWavetablePointers("Harmonics12"));

    setWavetablePointer(25, 0, WavetableContainer::getInstance().getWavetablePointers("Harmonics13"));//overtones 5-9
    setWavetablePointer(25, 1, WavetableContainer::getInstance().getWavetablePointers("Harmonics14"));
    setWavetablePointer(25, 2, WavetableContainer::getInstance().getWavetablePointers("Harmonics15"));
    setWavetablePointer(25, 3, WavetableContainer::getInstance().getWavetablePointers("Harmonics16"));

    setWavetablePointer(26, 0, WavetableContainer::getInstance().getWavetablePointers("Harmonics5"));
    setWavetablePointer(26, 1, WavetableContainer::getInstance().getWavetablePointers("Harmonics6"));
    setWavetablePointer(26, 2, WavetableContainer::getInstance().getWavetablePointers("Harmonics7"));
    setWavetablePointer(26, 3, WavetableContainer::getInstance().getWavetablePointers("Harmonics8"));

    setWavetablePointer(27, 0, WavetableContainer::getInstance().getWavetablePointers("Harmonics1"));
    setWavetablePointer(27, 1, WavetableContainer::getInstance().getWavetablePointers("Harmonics2"));
    ...
    setWavetablePointer(28, 2, WavetableContainer::getInstance().getWavetablePointers("FatSawMutated3"));
    setWavetablePointer(28, 3, WavetableContainer::getInstance().getWavetablePointers("FatSawMutated4"));

    setWavetablePointer(29, 0, WavetableContainer::getInstance().getWavetablePointers("FatSawMutated5"));
    setWavetablePointer(29, 1, WavetableContainer::getInstance().getWavetablePointers("FatSawMutated6"));
    setWavetablePointer(29, 2, WavetableContainer::getInstance().getWavetablePointers("FatSawMutated7"));
    setWavetablePointer(29, 3, WavetableContainer::getInstance().getWavetablePointers("FatSawMutated8"));

    setWavetablePointer(30, 0, WavetableContainer::getInstance().getWavetablePointers("ChiptuneSquare50Mutated1"));
    setWavetablePointer(30, 1, WavetableContainer::getInstance().getWavetablePointers("ChiptuneSquare50Mutated2"));
    setWavetablePointer(30, 2, WavetableContainer::getInstance().getWavetablePointers("ChiptuneSquare50Mutated3"));
    setWavetablePointer(30, 3, WavetableContainer::getInstance().getWavetablePointers("ChiptuneSquare50Mutated4"));
    
    setWavetablePointer(31, 0, WavetableContainer::getInstance().getWavetablePointers("ChiptuneSquare50Mutated5"));
    setWavetablePointer(31, 1, WavetableContainer::getInstance().getWavetablePointers("ChiptuneSquare50Mutated6"));
    setWavetablePointer(31, 2, WavetableContainer::getInstance().getWavetablePointers("ChiptuneSquare50Mutated7"));
    setWavetablePointer(31, 3, WavetableContainer::getInstance().getWavetablePointers("ChiptuneSquare50Mutated8"));


    setWavetablePointer(32, 0, WavetableContainer::getInstance().getWavetablePointers("Perlin1"));
    setWavetablePointer(32, 1, WavetableContainer::getInstance().getWavetablePointers("Perlin2"));
    setWavetablePointer(32, 2, WavetableContainer::getInstance().getWavetablePointers("Perlin3"));
    setWavetablePointer(32, 3, WavetableContainer::getInstance().getWavetablePointers("Perlin4"));
    
    setWavetablePointer(33, 0, WavetableContainer::getInstance().getWavetablePointers("Perlin5"));
    setWavetablePointer(33, 1, WavetableContainer::getInstance().getWavetablePointers("Perlin6"));
    setWavetablePointer(33, 2, WavetableContainer::getInstance().getWavetablePointers("Perlin7"));
    setWavetablePointer(33, 3, WavetableContainer::getInstance().getWavetablePointers("Perlin8"));

    setWavetablePointer(34, 0, WavetableContainer::getInstance().getWavetablePointers("Perlin9"));
    setWavetablePointer(34, 1, WavetableContainer::getInstance().getWavetablePointers("Perlin10"));
