...
public:
  ...
  float m_feedback_lower_limit =
      0.f; // used for resonance modulation down (is -1 in flanger)
  float m_feedback_higher_limit =
      1.f; // used for resonance modulation down (is 0.97 in flanger)
