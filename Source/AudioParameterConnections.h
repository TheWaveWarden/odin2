...
m_value_tree.addParameterListener("step_0_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_1_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_2_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_3_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_4_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_5_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_6_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_7_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_8_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_9_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_10_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_11_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_12_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_13_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_14_mod", &m_tree_listener_arp);
m_value_tree.addParameterListener("step_15_mod", &m_tree_listener_arp);
