...
bool OdinAudioProcessor::treeValueChangedSecond(const String &p_ID,
                                                float p_new_value)
{
  Identifier id(p_ID);
...
//a) performance
//b) win compiler can't handle too much elseifs .........
bool OdinAudioProcessor::treeValueChangedThird(const String &p_ID,
                                               float p_new_value)
{
  Identifier id(p_ID);
...
//a) performance
//b) win compiler can't handle too much elseifs .........
bool OdinAudioProcessor::treeValueChangedFourth(const String &p_ID,
                                                float p_new_value)
{
  Identifier id(p_ID);
