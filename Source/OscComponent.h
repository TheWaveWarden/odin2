...
#define WAVETABLE_WAVE_X 87
#define WAVETABLE_WAVE_Y 98
#define POSITION_POS_X 25
#define POSITION_POS_Y 90
#define POS_ENV_POS_X POSITION_POS_X
#define POS_ENV_POS_Y 41
