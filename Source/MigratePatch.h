void OdinAudioProcessor::migratePatch(int p_patch_nr_to_migrate_from) {
    ...
    switch(p_patch_nr_to_migrate_from){
        case 1:
        m_value_tree.state.removeProperty("amp_vel", nullptr);
        m_value_tree.state.setProperty("amp_width", 0.5,  nullptr);
        case 2:
    	//m_value_tree.state.setProperty("fancy_new_nonaudio_param_needed_for_version_3", 0, nullptr);
        default:
        break;
    }
}