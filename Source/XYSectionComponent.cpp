...
//==============================================================================
XYSectionComponent::XYSectionComponent() : m_xy_pad(m_modx, m_mody) {
  ...
  m_mody.setRange(0,1);
  m_mody.onValueChange = [&]{
      m_xy_pad.setY(m_mody.getValue());
  };
...
void XYSectionComponent::resized() {
  m_modx.setBounds(MODX_POS_X - BLACK_KNOB_VERY_SMALL_OFFSET_X,
                        MODX_POS_Y - BLACK_KNOB_VERY_SMALL_OFFSET_Y, BLACK_KNOB_VERY_SMALL_SIZE_X, BLACK_KNOB_VERY_SMALL_SIZE_Y);
  m_mody.setBounds(MODY_POS_X - BLACK_KNOB_VERY_SMALL_OFFSET_X,
                        MODY_POS_Y - BLACK_KNOB_VERY_SMALL_OFFSET_Y, BLACK_KNOB_VERY_SMALL_SIZE_X, BLACK_KNOB_VERY_SMALL_SIZE_Y);
}
