...
Some of the modulation sources and destinations inside Odin 2 are polyphonic (i.e. exist once per voice), while others are monophonic (exist once per plugin instance). The following table summarizes the behaviour when setting up poly/mono source and destination combos:
...
{\renewcommand{\arraystretch}{1.4}
    \begin{longtable}{| L{0.2\textwidth} | L{0.1\textwidth} | L{0.12\textwidth} |L{0.5\textwidth} |}
        ...
        \modsource{MIDI Note}{P}{U}{
            The index of the MIDI note-on event, scaled from 0 (note: 0) to 1 (note: 127).
        }
...
\newcommand{\moddestcategory}[1]{
    \multicolumn{3}{|c|}{\fat{#1}} \\
    \hline
}

{\renewcommand{\arraystretch}{1.4}
    \begin{longtable}{| L{0.2\textwidth} | L{0.36\textwidth} | L{0.4\textwidth}|}
        \hline
        ...
        \moddest{Filter Formant Transition}{
        ...
        \moddest{Env Attack}{
            Modulates the attack time of the Envelope exponentially and linearly.
        }{
        ...
        \moddest{Env Decay}{
            Modulates the decay time of the Envelope exponentially and linearly.
        }{
            Scales the current time by a factor of 8 and then adds 0.3 seconds.
        }{
            Scales the current time by a factor of $1/8$ and then subtracts 0.3 seconds.
        ...
        \moddest{Env Release}{
            Modulates the release time of the Envelope exponentially and linearly.
        }{
            Scales the current time by a factor of 8 and then adds 0.3 seconds.
        }{
            Scales the current time by a factor of $1/8$ and then subtracts 0.3 seconds.
        ...
        \moddest{LFO Freq}{
            Modulates the frequency of the LFO exponentially
        }{
